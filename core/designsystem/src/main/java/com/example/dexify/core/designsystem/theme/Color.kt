...
// Primary Pokédex Red palette
val PokedexRed = Color(0xFFDC0A2D)
val PokedexRedLight = Color(0xFFFF5252)
val PokedexRedDark = Color(0xFFA00020)
...
val LightSurfaceVariant = Color(0xFFEEF0F2)
...
// Pokémon type colors (for future use)
